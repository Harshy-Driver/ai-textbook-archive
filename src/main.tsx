...
const StudyPlanner = lazy(() => import("./pages/StudyPlanner.tsx"));
const Profile = lazy(() => import("./pages/Profile.tsx"));
const Settings = lazy(() => import("./pages/Settings.tsx"));
const SearchPage = lazy(() => import("./pages/Search.tsx"));
const QuickReview = lazy(() => import("./pages/QuickReview.tsx"));
        ...
        <BrowserRouter>
          ...
          <Suspense fallback={<RouteLoading />}>
            <Routes>
              ...
              <Route path="/chat/:lessonId" element={<RequireAuth><Chat /></RequireAuth>} />
              <Route path="/flashcards/:lessonId" element={<RequireAuth><Flashcards /></RequireAuth>} />
              <Route path="/planner" element={<RequireAuth><StudyPlanner /></RequireAuth>} />
              <Route path="/profile" element={<RequireAuth><Profile /></RequireAuth>} />
              <Route path="/settings" element={<RequireAuth><Settings /></RequireAuth>} />
              <Route path="/search" element={<RequireAuth><SearchPage /></RequireAuth>} />
              <Route path="/review/:lessonId" element={<RequireAuth><QuickReview /></RequireAuth>} />
